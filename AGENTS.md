...
| System-core package/release | `_ai_system/governance/16_system_core_packaging_rules.md` | `_ai_system/tools/validate_system_core_package.py`, `_ai_system/REFERENCE_INDEX.md` |
...
- System-core work must happen in the intended Git workspace with `origin` pointing to `Kdreammaker/doc-integrity-orchestrator`. Do not confuse the system core workspace with a fresh-install test workspace.
...
- System-core package validation: `python _ai_system/tools/validate_system_core_package.py --package-mode`
